...
def transform_df_and_export_parquet(
    ...
    df_invoice_clean["consommation_total"] = df_invoice_clean["consommation_level_1"] + df_invoice_clean["consommation_level_2"] + df_invoice_clean["consommation_level_3"] + df_invoice_clean["consommation_level_4"]
    df_invoice_clean["consommation_level_1_norm"] = (df_invoice_clean["consommation_level_1"] / df_invoice_clean["consommation_total"]) / df_invoice_clean["months_number"]
    df_invoice_clean["consommation_level_2_norm"] = (df_invoice_clean["consommation_level_2"] / df_invoice_clean["consommation_total"]) / df_invoice_clean["months_number"]
    df_invoice_clean["consommation_level_3_norm"] = (df_invoice_clean["consommation_level_3"] / df_invoice_clean["consommation_total"]) / df_invoice_clean["months_number"]
    df_invoice_clean["consommation_level_4_norm"] = (df_invoice_clean["consommation_level_4"] / df_invoice_clean["consommation_total"]) / df_invoice_clean["months_number"]
    ...
    cols_and_aggs = {
        ...
        "consommation_level_1_norm": {
            "is_active": True,
            "aggregation": "max",
        },
        "consommation_level_2_norm": {
            "is_active": True,
            "aggregation": "max",
        },
        "consommation_level_3_norm": {
            "is_active": True,
            "aggregation": "max",
        },
        "consommation_level_4_norm": {
            "is_active": True,
            "aggregation": "max",
        },
        "old_index": {
...
transform_df_and_export_parquet(
    client_train,
    invoice_train,
    "data/df_train_normcons_no_dummies_agg.parquet",
    "data/df_train_normcons_no_dummies_non_agg_norm.parquet",
)
transform_df_and_export_parquet(
    client_final_test,
    invoice_final_test,
    "data/df_final_test_normcons_no_dummies_agg.parquet",
    "data/df_final_test_normcons_no_dummies_non_agg.parquet",
)
