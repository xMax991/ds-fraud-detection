...
def transform_df_and_export_parquet(df_client, df_invoice, export_path_agg, export_path_non_agg):
    # Enrich invoice-level data with client data
...
transform_df_and_export_parquet(client_train, invoice_train, "data/df_train_agg.parquet", "data/df_train_non_agg.parquet")
transform_df_and_export_parquet(
    client_final_test, invoice_final_test, "data/df_final_test_agg.parquet", "data/df_final_test_non_agg.parquet")