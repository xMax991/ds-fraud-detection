...
transform_df_and_export_parquet(
    client_train,
    invoice_train,
    "data/df_train_no_dummies_agg_sum.parquet",
    "data/df_train_no_dummies_non_agg.parquet", #ignored as commented out above
)
transform_df_and_export_parquet(
    client_final_test,
    invoice_final_test,
    "data/df_final_test_no_dummies_agg_sum.parquet",
    "data/df_final_test_no_dummies_non_agg.parquet", #ignored as commented out above
)
